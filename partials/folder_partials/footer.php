    <footer class="footer-section overflow-hidden position-relative footer-style1">
                        ...
                        <div class="single-footer-widget">
                            <div class="widget-head">
                                <a href="index.php" class="footer-logo">
                                    ...
                                    <img src="../../global/photos/logo.png" alt="logo-img">
                                </a>
                            </div>
                            <div class="footer-content">
                                ...
                                <div class="social-wrapper social-empact d-flex align-items-center">
                                    <a href="https://www.facebook.com/Rasi-Seeds-103349728666008" class="white-clr"><i class="white-clr fab fa-facebook-f"></i></a>
                                    <a href="https://twitter.com/Rasi_seeds" class="white-clr">
                                    ...
                                    <a href="https://www.linkedin.com/company/729612/admin/" class="white-clr"><i class="white-clr fa-brands fa-linkedin-in"></i></a>
                                    <a href="https://goo.gl/iegjjE" class="white-clr"><i class="fab fa-youtube"></i></a>

                                    
                                    <a href="mailto:customercare@rasiseeds.com" class="white-clr"><i class="fas fa-envelope"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div
                    ...
                    <p class="wow fadeInLeft color-2" data-wow-delay=".3s">
                        Copyright &copy;  <?php echo date('Y'); ?> Rasi seeds. All Rights Reserved
                    </p>
        ...
        <!-- Element -->
        <img src="assets/img/footer/footer-wheat.png" alt="img" class="footer-wheat position-absolute">
        <!-- Element -->
    </footer>