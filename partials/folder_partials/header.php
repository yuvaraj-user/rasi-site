...
<head>
    ...
    <meta name="description" content="Rasi Seeds - Breeding Excellence">
    <!-- ======== Page title ============ -->
    <title>RASI SEEDS</title>
    <!--<< Favcion >>-->
    <link rel="shortcut icon" href="../assets/img/rasi/Rasi symbol.png">
    <!--<< Bootstrap min.css >>-->
    ...
    <link href="../assets/plugins/fileUpload/fileUpload.css" rel="stylesheet">
...
<body>
    ...
    <div id="preloader" class="preloader">
        <div class="box d-grid gap-4">
            <span class="man-pre m-auto">
                <!-- <img src="assets/img/banner/preloader.png" alt="img"> -->
                <!-- <img src="assets/img/banner/preloader.png" alt="img"> -->
                <img src="../assets/img/rasi/Rasi symbol.png" alt="img">
    ...
    <!-- ajax-preloader -->
    <div id="ajax-preloader" class="ajax-preloader">
        <div class="box d-grid gap-4">
            <span class="man-pre m-auto">
                <!-- <img src="assets/img/banner/preloader.png" alt="img"> -->
                <!-- <img src="assets/img/banner/preloader.png" alt="img"> -->
                ...
                <div class="offcanvas__content">
                    <div class="offcanvas__top mb-4 d-flex justify-content-between align-items-center">
                        <div class="offcanvas__logo">
                            <a href="index.html">
                                <img src="../assets/img/rasi/logo with glow.png" alt="logo-img" class="mobile-canvas-img">
                            </a>
                        </div>
