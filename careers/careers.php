        ...
        function get_jobs(action = 'all',department_name = '',location = '',job_role = ''){
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('.salesmark_info').text( ((response.job_count_data[0].sales_job_count > 0) ? (String(response.job_count_data[0].sales_job_count).padStart(2,'0')) : response.job_count_data[0].sales_job_count) ); 
