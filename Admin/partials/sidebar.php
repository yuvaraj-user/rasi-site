                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile dropdown m-t-20">
                                <div class="user-pic">
                                    <img src="../assets/images/rasi/user_avatar.png" alt="users" class="rounded-circle img-fluid" />
                                </div>
                                <div class="user-content hide-menu m-t-10">
                                    <h5 class="m-b-10 user-name font-medium"><?= $_SESSION['Name'] ?></h5>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="../post_job/job_list.php" aria-expanded="false">
                                <i class="icon-Sunglasses-Smiley"></i>
                                <span class="hide-menu">Career Opportunities</span>
                            </a>
                        </li>


                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="../career_application/career_application_list.php" aria-expanded="false">
                                <i class="icon-Sunglasses-Smiley"></i>
                                <span class="hide-menu">Career Applications</span>
                            </a>
                        </li>
